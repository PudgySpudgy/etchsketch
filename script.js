...
divOne.innerText = '1'
divTwo.innerText = '2'
divThree.innerText = '3'
divFour.innerText = '4'
divFive.innerText = '5'
divSix.innerText = '6'
divSeven.innerText = '7'
divEight.innerText = '8'
divNine.innerText = '9'
divTen.innerText = '10'
divEleven.innerText = '11'
divTwelve.innerText = '12'
divThirteen.innerText = '13'
divFourteen.innerText = '14'
divFifteen.innerText = '15'
divSixteen.innerText = '16'

divOne.className = 'box';
divTwo.className = 'box';
divThree.className = 'box';
divFour.className = 'box';
divFive.className = 'box';
divSix.className = 'box';
divSeven.className = 'box';
divEight.className = 'box';
divNine.className = 'box';
divTen.className = 'box';
divEleven.className = 'box';
divTwelve.className = 'box';
divThirteen.className = 'box';
divFourteen.className = 'box';
divFifteen.className = 'box';
divSixteen.className = 'box';
